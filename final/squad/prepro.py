...
def get_args():
    ...
    parser.add_argument('-s', "--source_dir", default='./data')
    parser.add_argument('-t', "--target_dir", default='./data')
    parser.add_argument('-d', "--debug", action='store_true')
    parser.add_argument("--train_ratio", default=0.9, type=int)
    parser.add_argument("--glove_corpus", default="6B")
    parser.add_argument("--glove_dir", default='./s_glove')
...
def prepro(args):
    ...
    if args.mode == 'full':
        # prepro_each(args, 'train',start_ratio=0.0, stop_ratio=0.9, out_name='train')
        # prepro_each(args, 'train',start_ratio=0.9, stop_ratio=1.0, out_name='dev')

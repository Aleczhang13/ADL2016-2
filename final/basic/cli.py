...
flags.DEFINE_string("data_dir", "./data", "Data dir [data/squad]")
...
flags.DEFINE_string("model_path", "", "path of output")
flags.DEFINE_string("answer_path", "", "answer path of output")
...
flags.DEFINE_integer("max_to_keep", 50, "Max recent saves to keep [20]")

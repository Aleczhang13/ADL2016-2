...
tf.app.flags.DEFINE_integer("word_embedding_size", 10, "Size of the word embedding")
tf.app.flags.DEFINE_integer("num_layers", 1, "Number of layers in the model.")
tf.app.flags.DEFINE_integer("in_vocab_size", 100, "max vocab Size.")
tf.app.flags.DEFINE_integer("out_vocab_size", 100, "max tag vocab Size.")
...
tf.app.flags.DEFINE_integer("max_training_steps", 3,
                            "Max training steps.")
